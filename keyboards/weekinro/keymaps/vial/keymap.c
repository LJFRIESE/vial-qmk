...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM]  = LAYOUT(
            ...
            KC_F24, KC_F18, KC_F19, KC_F20, KC_F21, KC_F22, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
            KC_1, KC_2, KC_3, KC_TRNS, MEH(KC_HOME), MEH(KC_PGDN), MEH(KC_PGUP), MEH(KC_END), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
